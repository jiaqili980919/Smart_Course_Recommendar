...
with open('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/LDA BOW/processed_docs.pkl copy', 'rb') as file:
...
with open('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/LDA BOW/index.pkl copy', 'rb') as file2:

    index = pickle.load(file2)

with open('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/LDA BOW/course_clean_1.pkl', 'rb') as file3:
    course_clean_1 = pickle.load(file3)

# with open('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/coursedata2.pkl',
#           'rb') as file4:
...
lda_model_final = models.LdaModel.load('/Users/manikantachundurubalaji/Downloads/USC/DataScience/DSCI560/Project/ldamodels_bow_60.lda')
...
for key,each in enumerate(result):
    ...
    each1 = textwrap.fill(text=each, width=max_char_count)
    # Add text to the image
    draw.text(xy=(img.size[0] / 2, img.size[1] / 2), text=each1, font=font, fill='#000000', anchor='mm')
    # view the result
    # img.show()
    img.save(f"results/{key}.png")
    str_="course_"+str(key)
    if str_ not in st.session_state:
        st.session_state[str_]=each
